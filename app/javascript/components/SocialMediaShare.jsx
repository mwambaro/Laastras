...
class SocialMediaShare extends React.Component
{
    ...
    componentDidMount()
    {
        this.hCenterTableOfSocialMediaItems();
        this.setState({
            rerender: true
        });
    }
    ...
    hCenterTableOfSocialMediaItems()
    {
        let elt = document.getElementById('social-media-share-modal-body');
        if(elt)
        {
            $('#social-media-share-modal-body').vcenter();
        }
    }
