class LaastrasMatureVideosController < ApplicationController
        ...
        begin 
            ...
            if videos.count == 0 
                ...
                videos.each do |video| 
                    @videos << {
                        view_url: url_for(
                            controller: 'laastras_mature_videos', 
                            action: 'show_video', 
    ...
    def show
        ...
        begin 
            id = params[:id]
            video = LaastrasMatureVideo.find(id) 
            if video.nil? 
    ...
    def show_video 
        ...
        begin 
            ...
            if sha256.nil? || sha256.blank?
                ...
                video = LaastrasMatureVideo.find_by_sha256(sha256)
                if video.nil?
